...
!function (a, b, c, d) {
    ...
    e.Workers = [
        {
            ...
            filter: ["items"],
            run: function () {
                this._coordinates.length < 1 && this
                    .$stage
                    .removeAttr("style")
            }
        }, {
            ...
            run: function () {
                ...
                for (c = 0, d = this._coordinates.length; c < d; c++) 
                    ...
                    (
                        this.op(a, "<=", g) && this.op(a, ">", h) || this.op(b, "<", g) && this.op(b, ">", h)
                    ) && i.push(c);
                this
                    .$stage
                    .children(".active")
    ...
    e.prototype.isVisible = function () {
        return !this.settings.checkVisibility || this
            .$element
            .is(":visible")
    },
    ...
    e.prototype.update = function () {
        for (
            ...
            (this._invalidated.all || a.grep(this._pipe[b].filter, d).length > 0) && this
                ._pipe[b]
                .run(e),
            b++;
        this._invalidated = {},
    ...
    e.prototype.refresh = function () {
        ...
        this
            .$element
            .addClass(this.options.refreshClass),
        this.update(),
        this
            .$element
    ...
    e.prototype.onResize = function () {
        return !!this._items.length && (
            this._width !== this.$element.width() && (!!this.isVisible() && (
                this.enter("resizing"),
    ...
    e.prototype.registerEventHandlers = function () {
        ...
        !1 !== this.settings.responsive && this.on(
            b,
            "resize",
            ...
            a.support.transform
                ...
                : (d = this.$stage.position(), d = {
                    x: this.settings.rtl
                        ? d.left + this
                            .$stage
                            .width() - this.width() + this.settings.margin
                        : d.left,
                    y: d.top
                }),
            this.is("animating") && (
    ...
    e.prototype.duration = function (a, b, c) {
        return 0 === c
            ? 0
            : Math.min(Math.max(Math.abs(b - a), 1), 6) * Math.abs(
    ...
    e.prototype.enter = function (b) {
        a.each([b].concat(this._states.tags[b] || []), a.proxy(function (a, b) {
            this
                ._states
                .current[b] === d && (this._states.current[b] = 0),
            this
                ._states
                .current[b]++
        }, this))
        ...
        if (b.type === e.Type.Event) {
            if (
                ...
                a
                    ...
                    .special[b.name]
                    ._default = function (a) {
                        return !c || !c.apply || a.namespace && -1 !== a
                            .namespace
                            .indexOf("owl")
                                ? a.namespace && a
                                    .namespace
        ...
        return this.each(function () {
            ...
            f || (
                ...
                a.each([
                    ...
                    f
                        .$element
                        .on(c + ".owl.carousel.core", a.proxy(function (a) {
            ...
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(
                function (b) {
                    if (b.namespace && this._core.settings && this._core.settings.lazyLoad && (b.property && "position" == b.property.name || "initialized" == b.type)) {
                        ...
                        for (
                            c.lazyLoadEager > 0 && (e += c.lazyLoadEager, c.loop && (g -= c.lazyLoadEager, e++));
                            f++ < e;
                        ) 
    ...
    var e = function (c) {
        ...
        this._handlers = {
            ...
            "loaded.owl.lazy": a.proxy(function (a) {
                a.namespace && this._core.settings.autoHeight && a
                    .element
...
function (a, b, c, d) {
    var e = function (b) {
        ...
        this._handlers = {
            "initialized.owl.carousel": a.proxy(function (a) {
                a.namespace && this
                    ._core
                    .register({type: "state", name: "playing", tags: ["interacting"]})
            }, this),
    ...
    e.prototype.play = function (b) {
        ...
        this._playing || (
            ...
            c = a(
                '<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScre' +
                'en ></iframe>'
            ),
            c.attr("height", h),
            c.attr("width", g),
...
function (a, b, c, d) {
        ...
        this._handlers = {
            ...
            "mouseover.owl.autoplay": a.proxy(function () {
                this._core.settings.autoplayHoverPause && this
                    ._core
                    .is("rotating") && this.pause()
            }, this),
            "mouseleave.owl.autoplay": a.proxy(function () {
                this._core.settings.autoplayHoverPause && this
                    ._core
                    .is("rotating") && this.play()
            }, this),
    ...
    e.prototype._next = function (d) {
        ...
        this
            ._core
            .is("interacting") || c.hidden || this
            ._core
            .next(d || this._core.settings.autoplaySpeed)
    },
...
function (a, b, c, d) {
    ...
    var e = function (b) {
        ...
        this._handlers = {
            "prepared.owl.carousel": a.proxy(function (b) {
                b.namespace && this._core.settings.dotsData && this
                    ._templates
                    .push(
                        '<div class="' + this._core.settings.dotClass + '">' + a(b.content).find("[data-dot]").addBack("[data-dot]").attr("data-dot") +
                        "</div>"
                    )
            }, this),
            "added.owl.carousel": a.proxy(function (a) {
                a.namespace && this._core.settings.dotsData && this
                    ._templates
                    .splice(a.position, 0, this._templates.pop())
            }, this),
    ...
    e.prototype.draw = function () {
        var b,
            ...
            e = this
                ._core
                .relative(this._core.current()),
            f = c.loop || c.rewind;
        this
            ._controls
            .$relative
            .toggleClass("disabled", !c.nav || d),
        c.nav && (
    ...
    e.prototype.current = function () {
        var b = this
            ...
            .relative(this._core.current());
        return a
            .grep(this._pages, a.proxy(function (a, c) {
        ...
        this._handlers = {
            ...
            "changed.owl.carousel": a.proxy(function (c) {
                if (c.namespace && "position" === c.property.name) {
                    var d = this
                            ._core
                            .items(this._core.relative(this._core.current())),
                        e = a
